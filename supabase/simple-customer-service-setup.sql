-- SIMPLE Customer Service Setup (No dependencies)
...
CREATE TABLE IF NOT EXISTS customer_conversations (
  ...
  user_id TEXT NOT NULL,  -- Changed from UUID to TEXT to avoid foreign key issues
...
-- Allow all operations (we'll control access via API)
...
-- ============================================
-- TABLE C: telegram_chat_mappings (for webhook)
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_telegram_chat_id ON telegram_chat_mappings(telegram_chat_id);
CREATE INDEX IF NOT EXISTS idx_telegram_conversation_id ON telegram_chat_mappings(conversation_id);
