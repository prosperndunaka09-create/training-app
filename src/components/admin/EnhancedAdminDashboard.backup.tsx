...
const EnhancedAdminDashboard: React.FC = () => {
  ...
  const loadData = useCallback(async (showRefreshToast = false) => {
    setIsLoading(true);
    try {
      // Simplified data loading - set default values immediately
      setUsers([]);
      setWithdrawals([]);
      setStats({
        totalUsers: 0, totalPayouts: 0, pendingPayouts: 0, totalBalance: 0,
              ...
              <div className="space-y-6">
                ...
                <Alert className="bg-orange-500/10 border-orange-500/20">
                  ...
                  <AlertDescription className="text-orange-400">
                    <strong>Warning:</strong> Account reset actions are irreversible and will be logged. 
                    This will reset all task progress and earnings for the specified account.
                  </AlertDescription>
                </Alert>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-slate-700/50 rounded-lg">
                    ...
                    <ul className="text-xs text-slate-300 space-y-1">
                      <li>• Tasks reset to 0/35 (VIP1) or 0/45 (VIP2)</li>
                      <li>• Balance and earnings preserved</li>
