...
export const TELEGRAM_CONFIG = {
  // Bot token from @BotFather - REPLACE WITH YOUR NEW BOT TOKEN
  BOT_TOKEN: '7578832675:AAHUf8pGIgBMlgFfJlBSQBoMokJO3v_Vl3o',
  
  // Chat ID from getUpdates API - REPLACE WITH YOUR NEW CHAT ID
  CHAT_ID: '7683177085',
...
// Test function to check if Telegram is configured
