...
const DAILY_BONUS_PRODUCTS = [
  { name: 'Diamond Edition Watch', brand: 'ChronoLux', price: 1299.99, category: 'Luxury', image: 'https://d64gsuwffb70l.cloudfront.net/69aa305f2571098cc28263b5_1772787129845_314ae005.jpg' },
  { name: 'Platinum Wireless Pro', brand: 'AudioElite', price: 599.99, category: 'Premium Audio', image: 'https://d64gsuwffb70l.cloudfront.net/69aa305f2571098cc28263b5_1772787089125_7fb09f77.jpg' },
  { name: 'Royal Signature Bag', brand: 'MaisonHaus', price: 899.99, category: 'Luxury Fashion', image: 'https://d64gsuwffb70l.cloudfront.net/69aa305f2571098cc28263b5_1772787207165_96f32090.jpg' },
  { name: 'Elite Gaming Station', brand: 'ProForge', price: 749.99, category: 'Premium Tech', image: 'https://d64gsuwffb70l.cloudfront.net/69aa305f2571098cc28263b5_1772787375145_9df53cc3.jpg' },
  { name: 'Obsidian Phone Ultra', brand: 'NexGen', price: 1499.99, category: 'Flagship', image: 'https://d64gsuwffb70l.cloudfront.net/69aa305f2571098cc28263b5_1772787228845_8846c466.jpg' },
  { name: 'Prestige Oud Parfum', brand: 'MaisonNoir', price: 499.99, category: 'Premium Beauty', image: 'https://d64gsuwffb70l.cloudfront.net/69aa305f2571098cc28263b5_1772787349749_f945ff9e.jpg' },
  { name: 'Velocity Max Runners', brand: 'EliteSport', price: 399.99, category: 'Premium Footwear', image: 'https://d64gsuwffb70l.cloudfront.net/69aa305f2571098cc28263b5_1772787181124_5bfe01ea.jpg' },
];

const BASE_DAILY_REWARD = 12.50; // 2x of a $6.25 average task
...
const DailyBonus: React.FC = () => {
  ...
  // Calculate streak-based reward: base + streak bonus
  const streakMultiplier = Math.min(bonusState.streak, 7); // max 7-day bonus
  const dailyReward = BASE_DAILY_REWARD + (streakMultiplier * 0.50); // +$0.50 per streak day
...
export const DailyBonusCompact: React.FC<{ onNavigate?: () => void }> = ({ onNavigate }) => {
  ...
  const dailyReward = BASE_DAILY_REWARD + (streakMultiplier * 0.50);
