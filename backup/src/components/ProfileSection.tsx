...
const ProfileSection: React.FC = () => {
  const { user, tasks, loadTasks, logout } = useAppContext();
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-5 bg-white/[0.03] border border-white/[0.06] rounded-2xl">
          ...
          <p className="text-xl font-bold text-purple-400">{completedCount}/35</p>
        </div>
        <div className="p-5 bg-white/[0.03] border border-white/[0.06] rounded-2xl">
      ...
      <div className="p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl">
        ...
        <div className="mb-3">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-gray-400">VIP1 Completion</span>
        ...
        <div className="flex items-center justify-between text-xs text-gray-500">
          ...
          <span>{35 - completedCount} remaining</span>
        </div>
      </div>
