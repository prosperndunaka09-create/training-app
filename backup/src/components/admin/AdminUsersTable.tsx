...
import { Search, Filter, ChevronDown, ChevronUp, User, ArrowUpDown, Eye, Ban, Shield, X } from 'lucide-react';
...
const AdminUsersTable: React.FC<AdminUsersTableProps> = ({ users, isLoading, onViewUser }) => {
                ...
                return (
                  <tr key={user.id} className="border-b border-white/[0.03] hover:bg-white/[0.02] transition-colors">
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-xs text-gray-500 lg:hidden truncate">{user.email}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3 text-right hidden md:table-cell">
                      <span className="text-sm text-gray-400">${user.total_earned.toFixed(2)}</span>
                    </td>
